...
#define XENO_HOST   0x8000  // Tracks whether we're infected with xenos.
...
#define UNRESTRICTED_SPECIES  list(SPECIES_NABBER,SPECIES_PROMETHEAN,SPECIES_YEOSA,SPECIES_HUMAN,SPECIES_DIONA,SPECIES_IPC,SPECIES_UNATHI,SPECIES_TRITONIAN,SPECIES_SPACER,SPECIES_VATGROWN,SPECIES_GRAVWORLDER,SPECIES_BOOSTER,SPECIES_MULE,SPECIES_CUSTOM,SPECIES_TAJ)
#define RESTRICTED_SPECIES    list(SPECIES_VOX,SPECIES_VOX_ARMALIS,SPECIES_ALIEN,SPECIES_GOLEM,SPECIES_MANTID_GYNE,SPECIES_MANTID_ALATE,SPECIES_MONARCH_WORKER,SPECIES_MONARCH_QUEEN,SPECIES_XENO, SPECIES_SKRELL)
