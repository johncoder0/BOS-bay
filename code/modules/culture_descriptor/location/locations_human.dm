...
/decl/cultural_info/location/human/terra
	...
	description = "Terra, in the Gilgamesh system. Terra is the home of the United Colonies of Gilgamesh, and the capital of that \
	particular superpower. Terra is one of the many affiliated planets in the ICCG and the one that is perhaps the most important. Terra, much like most of the ICCG, is isolationist, with a minimal \
	...
	increasingly high taxes. This state of affairs has seen the immigration of many Terra citizens to the SCG in recent years, hoping to escape the poor conditions they found themselves in. Despite this,\
...
/decl/cultural_info/location/human/cinu
	...
	with many refusing to participate in the Defence Forces. Instead, they serve as peacekeepers and diplomats. The Cinuan People were controversially non-aligned during the Gaia Conflict."
	capital = "Al-Mular"
	economic_power = 1.0
...
/decl/cultural_info/location/human/yuklid
	...
	The Republic of Yuklid is a minor political player within the SCG, and the SolGov Republican Guard use the planet for exoplanet training. It is protected by the Third Fleet. \
...
/decl/cultural_info/location/human/gaia
	...
	description = "Gaia is the sole planet in the Gaiaion system, serving as the DMZ between the SCG and the ICCG. \
	...
	The planet's population remain divided even 10 years after the Gaia Conflict. New Venice sits on the edge of Lake Cabot. While Gaia is divided \
	the current Mayor of New Venice serves as a vital mediator between both sides. <br><br> The Gaia People are tired of war, and long to see their families \
