...
/decl/cultural_info/culture/human/confederate
	...
	description = "You are from Terra (not Earth), in the Gilgamesh system. The capital world of the United Colonies of Gilgamesh, your people embody what it means to be a part of the ICCG. \
	...
	in the military, industrial, government or service sectors, with an emphasis being placed on military service. Terraians today are generally poor, bitter and a somewhat broken people angry and \
