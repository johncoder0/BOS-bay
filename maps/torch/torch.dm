...
//	#include "items/uniform_vendor_boh.dm"
	...
	#include "bos/job/torch_departments.dm"
	#include "bos/job/torch_access.dm"
	#include "bos/job/torch_jobs.dm"
	#include "bos/job/command_jobs.dm"
//	#include "job/corporate_jobs.dm"
	#include "bos/job/engineering_jobs.dm"
//	#include "job/exploration_jobs.dm"
	#include "bos/job/medical_jobs.dm"
	#include "job/misc_jobs.dm"
	#include "bos/job/security_jobs.dm"
	#include "bos/job/marine_jobs.dm"
	#include "bos/job/aux_jobs.dm"
