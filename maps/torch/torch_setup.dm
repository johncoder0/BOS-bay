...
/datum/map/torch/get_map_info()
	. = list()
	. += "«Добро пожаловать на борт этого прекрасного, величественного и недавно освобожденного от грязных, подлых и несчастных западных предателей Великой Лордании - ЛРК Дагон. "
